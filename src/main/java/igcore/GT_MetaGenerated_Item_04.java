...
public class GT_MetaGenerated_Item_04
    ...
    public GT_MetaGenerated_Item_04() {
        ...
        ItemListIG.Iron			.set(addItem(tLastID = 25, "Ore Trade Licence", "Brown Limonite, Yellow Limonite, Banded Iron, Malachite", new Object(){}));//1
        ItemListIG.Cassiterite	.set(addItem(tLastID = 26, "Ore Trade Licence", "Tin, Cassiterite", new Object(){}));										//1
        ItemListIG.Tetrahedrite	.set(addItem(tLastID = 27, "Ore Trade Licence", "Tetrahedrite, Copper, Stibnite", new Object(){}));
        ItemListIG.NetherQuartz	.set(addItem(tLastID = 28, "Ore Trade Licence", "Nether Quartz", new Object(){}));
        ItemListIG.Sulfur		.set(addItem(tLastID = 29, "Ore Trade Licence", "Sulfur, Pyrite, Sphalerite", new Object(){}));
        ...
        ItemListIG.Salts		.set(addItem(tLastID = 32, "Ore Trade Licence", "Rock Salt, Salt Lepidolite, Spodumene", new Object(){}));
        ItemListIG.Redstone		.set(addItem(tLastID = 33, "Ore Trade Licence", "Redstone, Ruby, Cinnabar", new Object(){})); 								//1
        ItemListIG.Soapstone	.set(addItem(tLastID = 34, "Ore Trade Licence", "Soapstone, Talc, Glauconite, Pentlandite", new Object(){}));
        ...
        ItemListIG.Molybdenum	.set(addItem(tLastID = 40, "Ore Trade Licence", "Wulfenite, Molybdenite, Molybdenum, Powellite", new Object(){}));
        ItemListIG.Tungstate	.set(addItem(tLastID = 41, "Ore Trade Licence", "Scheelite, Tungstate, Lithium", new Object(){}));
        ItemListIG.Sapphire		.set(addItem(tLastID = 42, "Ore Trade Licence", "Almandine, Pyrope, Sapphire, Green Sapphire", new Object(){}));
        ItemListIG.Manganese	.set(addItem(tLastID = 43, "Ore Trade Licence", "Grossular, Spessartine, Pyrolusite, Tantalite", new Object(){}));
        ItemListIG.Quartz		.set(addItem(tLastID = 44, "Ore Trade Licence", "Quartzite, Barite, Certus Quartz", new Object(){}));
        ItemListIG.Diamond		.set(addItem(tLastID = 45, "Ore Trade Licence", "Graphite, Diamond, Coal", new Object(){}));
        ItemListIG.Olivine		.set(addItem(tLastID = 46, "Ore Trade Licence", "Bentonite, Magnesite, Olivine, Glauconite", new Object(){}));
        ItemListIG.Apatite		.set(addItem(tLastID = 47, "Ore Trade Licence", "Apatite, Phosphorus, Phosphate", new Object(){}));
        ItemListIG.Galena		.set(addItem(tLastID = 48, "Ore Trade Licence", "Galena, Silver, Lead", new Object(){}));
        ItemListIG.Lapis		.set(addItem(tLastID = 49, "Ore Trade Licence", "Lazurite, Sodalite, Lapis, Calcite", new Object(){}));
        ItemListIG.Beryllium	.set(addItem(tLastID = 50, "Ore Trade Licence", "Beryllium, Emerald, Thorium", new Object(){}));
        ...
        ItemListIG.Trade_Chemical.set(addItem(tLastID = 63, "Chemicals Trade Licence","Liquid Gold and more", new Object()));
        ...
        ItemListIG.Trade_Metal.set(addItem(tLastID = 67, "Mechanical Parts Trade Licence","For other factories", new Object()));			//1
        ItemListIG.Trade_Engineering.set(addItem(tLastID = 68, "Engineering Trade Licence","Sell instead of use", new Object()));
