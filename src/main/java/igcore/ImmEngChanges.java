...
//		MetalPressRecipe.recipeList.clear();
		...
		for(Materials mMaterial : Util.tMats){
			  Materials tMaterial = mMaterial.mOreReplacement;Materials tPrimaryByMaterial = null;Materials tSecondaryByMaterial = null;
				...
				IERecipes.addOredictRecipe(new ItemStack(IEContent.blockStoneDecoration,4,6), "NBN","BDB","NBN", 'B',new ItemStack(IEContent.blockStoneDecoration,1,1),'N',"ingotSteel",'D',new ItemStack(Blocks.nether_brick));
